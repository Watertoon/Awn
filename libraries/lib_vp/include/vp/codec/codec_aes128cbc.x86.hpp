...
namespace vp::codec {
    ...
    ALWAYS_INLINE vp::util::sse4::v2sll Aesenc(vp::util::sse4::v2sll a, vp::util::sse4::v2sll round_key) {
        return __builtin_ia32_aesenc128(a, round_key);
    }

    ALWAYS_INLINE vp::util::sse4::v2sll Aesenclast(vp::util::sse4::v2sll a, vp::util::sse4::v2sll round_key) {
